...
int main(void) {
        ...
        if (result) {
                ...
                printf("[tests/test_t-uchar_f-f32-3.c]:	ALL TESTS PASSED\n");
        }
        return result != 0;
}
